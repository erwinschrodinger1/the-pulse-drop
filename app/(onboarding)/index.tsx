      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={{ width }} className="flex-1 items-center justify-center px-6">
            {/* Image card */}
            <View className="w-full items-center justify-center overflow-hidden rounded-3xl border border-blue-100 bg-blue-50 py-8">
            ...
            <Text className="mt-3 px-4 text-center leading-6 text-gray-500">{item.desc}</Text>
          </View>
        )}
      />
